...
def crop_image(input_path, output_path, crop_rectangle):
    """
    Crop an image and save it to the specified output path.

    Parameters:
    - input_path: Path to the input image.
    - output_path: Path where the cropped image will be saved.
    - crop_rectangle: A tuple (left, upper, right, lower) specifying the crop rectangle.
    """
...
if __name__ == "__main__":
    ...
    # Assuming other parts of your script remain unchanged
    #crop_rectangle = (100, 100, 400, 400)  # Example crop rectangle, adjust as needed
    #crop_rectangle = (400, 300, 1200, 900)  # Crop rectangle for the middle section
    crop_rectangle = (400, 250, 1200, 950)  # Adjusted crop rectangle for the middle section, 50 pixels higher

    #cropped_picture_path = 'cropped_' + picture_path
    crop_image(picture_path, picture_path, crop_rectangle)
